...
#
# NOTE: Branch protection rules require either a GitHub Pro subscription or a public
#       repository. Neither is currently available. Awaiting resolution either through:
#       - GitHub Pro organization subscription, or
#       - Licensing decision regarding repository visibility.
...
#
# COMMENTED OUT: Requires GitHub Pro subscription or public repository
# (neither currently available - awaiting Pro org subscription or licensing decision)
#
