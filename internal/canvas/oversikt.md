...
Denne modulen bygger videre på grunnleggende backend-utvikling og gir deg praktisk erfaring med moderne verktøy og arbeidsformer.  
...
- **Mål:** Du skal utforske hvordan testdrevet utvikling kan brukes til å bygge en liten API-tjeneste.
...
- **Mål:** Du skal lære hvordan du containeriserer applikasjoner og kobler dem sammen i et enkelt system.
...
- **Mål:** Du skal få innsikt i hvordan infrastruktur kan defineres og kjøres som kode.
...
- **Mål:** Du skal utforske autentisering via tredjepart og bygging av enkle CLI-verktøy.
...
## Utviklingspraksis og metode

> For instruktører: Dette er den sentrale læringsdelen i modulen og danner grunnlaget for vurdering.

Dette handler om **hvordan** du utvikler – ikke bare hva du bygger.
...
## Bakenforliggende konsepter

> For instruktører: Disse temaene danner bakteppet for modulens praksis og brukes som referanser i refleksjon, diskusjon og demonstrasjon.

Disse temaene gir deg bakgrunnskunnskap som du kan bruke i refleksjon, diskusjon og demonstrasjon.
...
Modulen fokuserer på å **bygge og forstå**, med vekt på utviklingspraksis og refleksjon rundt hvordan du nærmer deg problemløsning.  
